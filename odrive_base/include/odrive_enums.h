...
enum ODriveAxisState {
    ...
    AXIS6_STATE_ANTICOGGING_CALIBRATION       = 14,
};

// ODrive.Encoder.Mode
enum ODriveEncoderMode {
...
enum ODriveSensorlessEstimatorError {
...
enum ODrive6Error {
    ODRIVE6_ERROR_NONE                        = 0x00000000,
    ODRIVE6_ERROR_INITIALIZING                = 0x00000001,
    ODRIVE6_ERROR_SYSTEM_LEVEL                = 0x00000002,
    ODRIVE6_ERROR_TIMING_ERROR                = 0x00000004,
    ODRIVE6_ERROR_MISSING_ESTIMATE            = 0x00000008,
    ODRIVE6_ERROR_BAD_CONFIG                  = 0x00000010,
    ODRIVE6_ERROR_DRV_FAULT                   = 0x00000020,
    ODRIVE6_ERROR_MISSING_INPUT               = 0x00000040,
    ODRIVE6_ERROR_DC_BUS_OVER_VOLTAGE         = 0x00000100,
    ODRIVE6_ERROR_DC_BUS_UNDER_VOLTAGE        = 0x00000200,
    ODRIVE6_ERROR_DC_BUS_OVER_CURRENT         = 0x00000400,
    ODRIVE6_ERROR_DC_BUS_OVER_REGEN_CURRENT   = 0x00000800,
    ODRIVE6_ERROR_CURRENT_LIMIT_VIOLATION     = 0x00001000,
    ODRIVE6_ERROR_MOTOR_OVER_TEMP             = 0x00002000,
    ODRIVE6_ERROR_INVERTER_OVER_TEMP          = 0x00004000,
    ODRIVE6_ERROR_VELOCITY_LIMIT_VIOLATION    = 0x00008000,
    ODRIVE6_ERROR_POSITION_LIMIT_VIOLATION    = 0x00010000,
    ODRIVE6_ERROR_WATCHDOG_TIMER_EXPIRED      = 0x01000000,
    ODRIVE6_ERROR_ESTOP_REQUESTED             = 0x02000000,
    ODRIVE6_ERROR_SPINOUT_DETECTED            = 0x04000000,
    ODRIVE6_ERROR_BRAKE_RESISTOR_DISARMED     = 0x08000000,
    ODRIVE6_ERROR_THERMISTOR_DISCONNECTED     = 0x10000000,
    ODRIVE6_ERROR_CALIBRATION_ERROR           = 0x40000000,
};
